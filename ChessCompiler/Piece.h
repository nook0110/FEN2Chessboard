...
private:
	...
	static bool checkCheck(const std::vector<std::vector<Piece*>>& board, bool colorWhite, std::string info);
public:
...
public:
	...
	virtual bool canMoveTo(sf::Vector2i square, const std::vector<std::vector<Piece*>>& board, const std::string& info) const = 0;
};
...
public:
	...
	bool canMoveTo(sf::Vector2i square, const std::vector<std::vector<Piece*>>& board, const std::string& info) const override;
};
